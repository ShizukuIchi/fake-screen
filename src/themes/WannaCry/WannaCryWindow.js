        ...
        <section className="left">
          ...
          <div className="infos-container">
            ...
            <div className="infos-content">
              ...
              <div className="bar">
                <div className="bar-color">
                  <div style={{ height: loseProgress }} className="bar-cover" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="manuals">
            <div className="manual">
              ...
              <p>
                ...
                Maybe you are busy looking for a way to recover your files, but
                do not waste your time. Nobody can recover your files without
            ...
            <div className="manual">
              ...
              <p>But if you want to decrypt all your files, you need to pay.</p>
              <p>
                You only have 3 days to submit the payment. After that the price
                will be doubled.
              </p>
              <p>
            ...
            <div className="manual">
              ...
              <p>
                ...
                For more information, click &lt;How to buy bitcoins&gt;.
              </p>
              <p>
              ...
              <p>
                Once the payment is checked, you can start decrypting your files
                immediately.
              </p>
            </div>
            <div className="manual">
